...
private:
    ...
    std::array<StringSettingValue, stringSettingsSize> m_stringSettings{
        ...
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardThree,
                            ...
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardFour,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardFour" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardFive,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardFive" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardSix,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardSix" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardSeven,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardSeven" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardEight,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardEight" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardNine,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardNine" },
                            discordDefaultMuteKeybinding },
        StringSettingValue{ StringSetting::KEYBOARDSHORTCUT_keyboardTen,
                            SettingCategory::KeyboardShortcut,
                            QtInfo{ "keyboardTen" },
                            discordDefaultMuteKeybinding },
